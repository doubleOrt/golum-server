...
$all_contacts_arr_prepared->execute([":user_id" => $_GET["user_id"], ":base_user_id" => $_SESSION["user_id"]]);
...
$contacts_male_female_widget_prepared->execute([":user_id" => $_GET["user_id"], ":base_user_id" => $_SESSION["user_id"]]);
...
"avatar_picture" => ($row["avatar_picture"] != "" ? $SERVER_URL . htmlspecialchars($row["avatar_picture"], ENT_QUOTES, "utf-8") : ""),
