...
$con->prepare("update messages set read_yet = 1 where chat_id = :chat_id and message_from != :base_user_id ")->execute([":chat_id" => $_POST["chat_id"], ":base_user_id" => $GLOBALS["base_user_id"]]);		
}
