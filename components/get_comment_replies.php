...
$post_comments_arr_prepared->execute([":base_user_id" => $_SESSION["user_id"], ":comment_id" => $_GET["comment_id"]]);
...
$comment_replies_total_num_prepared->execute([":comment_id" => $_GET["comment_id"], ":base_user_id" => $_SESSION["user_id"]]);
