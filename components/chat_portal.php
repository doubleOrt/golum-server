...
$chat_portal_user_info_arr = custom_pdo("select id, first_name, last_name, user_name, avatar_picture from users where id = :user_id", [":user_id" => $row["chat_recipient"]])->fetch();
