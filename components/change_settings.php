...
$mail->setFrom('fantasybl8@gmail.com', "Email Verification - Ortify");
$mail->addAddress($add_email, 'Message From Ortify');     // Add a recipient
$mail->addReplyTo('fantasybl8@gmail.com', '');
$mail->isHTML(true);                                  // Set email format to HTML

$mail->Subject = $user_info_arr["user_name"];
$mail->Body = "Hello <b>" . $user_info_arr["user_name"] . "</b>, You Recently Requested To Link This Email To Your Account.
Here Is The Email Confirmation Code: ".$activation_code."
<br>
You Will Need The Above Code To Complete The Email Linking Process.";
$mail->AltBody = "";
