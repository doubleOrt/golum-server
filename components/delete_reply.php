...
custom_pdo("delete from notifications where notification_from = :base_user_id and notification_to = :commenter_id and type = 3 and extra = :comment_id and extra2 = :post_id and extra3 = :reply_id", [":base_user_id" => $GLOBALS["base_user_id"], ":commenter_id" => $comment_arr["id"], ":comment_id" => $comment_arr["id"], ":post_id" => $comment_arr["post_id"], ":reply_id" => $_POST["reply_id"]]);
