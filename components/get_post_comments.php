...
$post_comments_arr_prepared->execute([":base_user_id" => $_SESSION["user_id"], ":post_id" => $_GET["post_id"]]);
...
$post_comments_total_num_prepared->execute([":post_id" => $_GET["post_id"], ":base_user_id" => $_SESSION["user_id"]]);
