...
"avatar_picture" => ($friend_arr["avatar_picture"] != "" ? (preg_match('/https?:\/\/[^ ]+?(?:\.jpg|\.png|\.gif)/', $friend_arr["avatar_picture"]) ? $friend_arr["avatar_picture"] : ($SERVER_URL . htmlspecialchars($friend_arr["avatar_picture"], ENT_QUOTES, "utf-8"))) : ""),
