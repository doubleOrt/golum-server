...
$current_tag_follow_state = custom_pdo("select id from following_tags where id_of_user = :base_user_id and tag = :tag", [":base_user_id" => $GLOBALS["base_user_id"], ":tag" => $_GET["tag"]])->fetch();
