...
'background': '". ($user_modal_info_arr["avatar_picture"] != "" ? $SERVER_URL . htmlspecialchars($user_modal_info_arr["background_path"], ENT_QUOTES, "utf-8") : "") ."',
'avatar': '". ($user_modal_info_arr["avatar_picture"] != "" ? $SERVER_URL . htmlspecialchars($user_modal_info_arr["avatar_picture"], ENT_QUOTES, "utf-8") : "") ."',
